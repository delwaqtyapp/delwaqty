...
class MockProductRepository implements ProductRepository {
  ...
  Future<List<Product>> getFeaturedProducts(String merchantId) async =>
      _products
          .where((p) => p.merchantId == merchantId && p.isFeatured)
          .toList();
...
List<Product> _sampleProducts() => [
  ...
  Product(
    ...
    variants: [
      ProductVariant(id: 'v1', productId: 'p1', name: 'Regular', price: 35.0),
      ProductVariant(id: 'v2', productId: 'p1', name: 'Large', price: 45.0),
      ProductVariant(id: 'v3', productId: 'p1', name: 'Family', price: 85.0),
    ],
  ),
  Product(
    id: 'p2',
