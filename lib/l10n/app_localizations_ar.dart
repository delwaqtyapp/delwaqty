...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get welcomeRegisterButton => 'إنشاء حساب جديد';

  @override
  String get welcomeGuestButton => 'المتابعة كضيف';
  ...
  @override
  String get tosSection1Title => '1. قبول الشروط';

  @override
  String get tosSection1Body =>
      'باستخدام تطبيق دلوقتي أو الوصول إليه، أنت توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على هذه الشروط، يرجى عدم استخدام خدماتنا. نحتفظ بحق تعديل هذه الشروط في أي وقت، واستخدامك المستمر للخدمة يشكل قبولاً لأي تغييرات.';

  @override
  String get tosSection2Title => '2. وصف الخدمة';
  ...
  String get tosSection3Body =>
      'يجب عليك إنشاء حساب لاستخدام خدمات دلوقتي. أنت مسؤول عن الحفاظ على سرية بيانات تسجيل دخول حسابك وجميع الأنشطة التي تحدث تحت حسابك. أنت توافق على تقديم معلومات دقيقة وشاملة أثناء التسجيل وتحديث معلومات حسابك. يجب أن يكون عمرك 18 سنة على الأقل لإنشاء حساب.';

  @override
  String get tosSection4Title => '4. الطلبات والمدفوعات';
  ...
  String get tosSection7Body =>
      'بأقصى حد يسمح به القانون، لن تتحمل دلوقتي المسؤولية عن أي أضرار غير مباشرة أو عرضية أو خاصة أو تبعية ناشئة عن استخدامك لخدماتنا. مسؤوليتنا الإجمالية لن تتجاوز المبلغ الذي دفعته للخدمة المعنية بالادعاء. لسنا مسؤولين عن التأخيرات أو الإلغاءات أو مشاكل الجودة الناتجة عن مزودي الخدمات من أطراف ثالثة.';

  @override
  String get ppLastUpdated => 'آخر تحديث: 1 يناير 2025';

  @override
  String get ppSection1Title => '1. المعلومات التي نجمعها';

  @override
  String get ppSection1Body =>
      'نجمع المعلومات التي تقدمها مباشرة، بما في ذلك اسمك وعنوان بريدك الإلكتروني ورقم هاتفك ومعلومات الدفع وعناوين التوصيل. كما نجمع معلومات الجهاز مثل نوع جهازك ونظام التشغيل ومعرفات الجهاز الفريدة. عند استخدام خدماتنا، نجمع تلقائياً بيانات الموقع ومعلومات الاستخدام مثل سجل الطلبات والتفضيلات.';

  @override
  String get ppSection2Title => '2. كيف نستخدم معلوماتك';

  @override
  String get ppSection2Body =>
      'نستخدم معلوماتك لتقديم وتحسين خدماتنا ومعالجة المعاملات وإرسال تحديثات الطلبات والإشعارات وتخصيص تجربتك واكتشاف ومنع الاحتيال والتواصل معك حول العروض والتحديثات. قد نستخدم أيضاً البيانات المجمعة والمجهولة للتحليلات وتحسين الخدمة.';

  @override
  String get ppSection3Title => '3. بيانات الموقع';
  ...
  String get ppSection5Body =>
      'نقوم بتطبيق تدابير أمان معيارية لحماية معلوماتك الشخصية، بما في ذلك التشفير أثناء النقل والتخزين، والخوادم الآمنة، والتدقيق الأمني المنتظم. على الرغم من جهودنا في حماية بياناتك، لا توجد طريقة نقل أو تخزين إلكتروني آمنة بنسبة 100%، ولا يمكننا ضمان الأمان المطلق.';

  @override
  String get ppSection6Title => '6. حقوقك';

  @override
  String get ppSection6Body =>
      'لك الحق في الوصول إلى معلوماتك الشخصية أو تصحيحها أو حذفها في أي وقت من خلال إعدادات التطبيق. يمكنك أيضاً طلب نسخة من بياناتك، واختيار عدم تلقي اتصالات التسويق، والتحكم في تفضيلات الخصوصية الخاصة بك. لممارسة هذه الحقوق، تواصل معنا على support@delwaqty.com.';

  @override
  String get ppSection7Title => '7. خصوصية الأطفال';

  @override
  String get ppSection7Body =>
      'خدمات دلوقتي غير مخصصة للأفراد الذين تقل أعمارهم عن 18 عاماً. لا نجمع معلومات شخصية من الأطفال عن علم. إذا علمنا أن طفلاً قد قدم لنا معلومات شخصية، سنقوم باتخاذ خطوات لحذف هذه المعلومات فوراً.';

  @override
  String get ppSection8Title => '8. التغييرات على السياسة';

  @override
  String get ppSection8Body =>
      'قد نقوم بتحديث سياسة الخصوصية هذه من وقت لآخر لعكس التغييرات في ممارساتنا أو المتطلبات القانونية. سنقوم بإبلاغك بأي تغييرات جوهرية من خلال نشر السياسة المحدثة في التطبيق وعن طريق البريد الإلكتروني أو الإشعار. استخدامك المستمر للخدمة بعد التغييرات يشكل قبولاً للسياسة المحدثة.';

  @override
  String get helpSection => 'الأسئلة المتكررة';

  @override
  String get faqQuestion1 => 'كيف أقوم بتقديم طلب؟';

  @override
  String get faqAnswer1 =>
      'تصفح المطاعم أو المتاجر القريبة منك، أضف المنتجات إلى سلة التسوق، أكّد عنوان التوصيل، ثم اضغط على تقديم الطلب. يمكنك الدفع نقداً أو من المحفظة أو بالبطاقة حسب التوفر.';

  @override
  String get faqQuestion2 => 'كيف أتتبع طلبي؟';
  ...
  String get faqAnswer4 =>
      'اذهب إلى قسم المحفظة من القائمة الجانبية واضغط على الشحن. اختر طريقة الدفع التي تفضلها وأدخل المبلغ. سيتم تحديث رصيدك فوراً بعد نجاح الدفع.';
  ...
  String get faqAnswer5 =>
      'يمكنك التواصل مع فريق الدعم عبر البريد الإلكتروني على support@delwaqty.com أو من خلال قسم تواصل معنا في التطبيق. فريقنا متاح على مدار الساعة لمساعدتك في أي مشاكل أو استفسارات.';

  @override
  String get faqQuestion6 => 'كيف أبلّغ عن مشكلة؟';
  ...
  @override
  String get closeChat => 'إغلاق الدردشة';

  @override
  String get closeChatConfirm =>
      'هل أنت متأكد من إغلاق هذه الدردشة؟ سيتم حذف سجل المحادثة بعد 7 أيام.';

  @override
  String get closeChatConfirmTitle => 'إغلاق الدردشة';

  @override
  String get chatClosed => 'تم إغلاق هذه الدردشة بواسطة فريق الدعم.';

  @override
  String get chatClosedLabel => 'مغلق';

  @override
  String get sendingMedia => 'جاري إرسال الوسائط...';

  @override
  String get sendImage => 'إرسال صورة';

  @override
  String get sendVideo => 'إرسال فيديو';

  @override
  String get sendVoiceMessage => 'إرسال رسالة صوتية';

  @override
  String get voiceRecording => 'جاري التسجيل... ارفع إصبعك للإرسال';
  ...
  String welcomeCustomerMessage(Object name) {
    return 'أهلاً بك في دعم Delwaqty! أنا $name من قسم الدعم وسأساعدك في حل مشكلتك.';
  }

  @override
  String get welcomeSection => 'قسم الدعم';

  @override
  String get tapToPlay => 'اضغط للتشغيل';

  @override
  String get tapToRecord => 'اضغط مطولاً للتسجيل';
