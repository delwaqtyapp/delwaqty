...
final GlobalKey<NavigatorState> providerRootNavigatorKey = GlobalKey<NavigatorState>(
  debugLabel: 'provider-root',
);

final providerGoRouterProvider = Provider<GoRouter>((ref) {
