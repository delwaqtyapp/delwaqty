                            ...
                            children: [
                              ...
                              if (isAdmin) ...[
                                ...
                                CollapsibleSidebarSection(
                                  ...
                                  collapseTooltip: widget.l10n.adminCollapse,
                                  expandTooltip: widget.l10n.adminExpand,
                                  items: [
                                    _AdminGroupLabel(
                                      label: widget.l10n.adminOperationsSection,
                                    ),
                                    SidebarItem(
                                    ...
                                    SidebarItem(
                                      ...
                                      label: widget.l10n.adminMembers,
                                    ...
                                    SidebarItem(
                                      ...
                                      label: widget.l10n.adminUsersPage,
                                      isSelected: _selectedIndex == 20,
                                      onTap: () {
                                    ...
                                    SidebarItem(
                                      ...
                                      label: widget.l10n.adminMerchants,
                                      isSelected: _selectedIndex == 21,
                                      onTap: () {
                                        setState(() => _selectedIndex = 21);
                                        _navigate('/admin/merchants');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.local_shipping_rounded,
                                      label: widget.l10n.adminDrivers,
                                      isSelected: _selectedIndex == 22,
                                      onTap: () {
                                        setState(() => _selectedIndex = 22);
                                        _navigate('/admin/drivers');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.receipt_long_rounded,
                                      label: widget.l10n.adminOrdersPage,
                                      isSelected: _selectedIndex == 23,
                                      onTap: () {
                                        setState(() => _selectedIndex = 23);
                                        _navigate('/admin/orders');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.delivery_dining_rounded,
                                      label: widget.l10n.adminDeliveries,
                                      isSelected: _selectedIndex == 24,
                                      onTap: () {
                                        setState(() => _selectedIndex = 24);
                                        _navigate('/admin/deliveries');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.verified_user_rounded,
                                      label: widget.l10n.adminVerifications,
                                      isSelected: _selectedIndex == 25,
                                      onTap: () {
                                        setState(() => _selectedIndex = 25);
                                        _navigate('/admin/verifications');
                                      },
                                    ),
                                    SidebarItem(
                                    ...
                                    SidebarItem(
                                      ...
                                      label: widget.l10n.adminEscalations,
                                      isSelected: _selectedIndex == 26,
                                      onTap: () {
                                        setState(() => _selectedIndex = 26);
                                        _navigate('/admin/escalations');
                                      },
                                    ),
                                    SidebarItem(
                                    ...
                                    _AdminGroupLabel(
                                      label: widget.l10n.adminSupportSection,
                                    ),
                                    SidebarItem(
                                    ...
                                    SidebarItem(
                                      ...
                                      label: widget.l10n.adminEmergency,
                                      isSelected: _selectedIndex == 27,
                                      onTap: () {
                                        setState(() => _selectedIndex = 27);
                                        _navigate('/admin/emergency');
                                      },
                                    ),
                                    _AdminGroupLabel(
                                      label: widget.l10n.adminFinancialSection,
                                    ),
                                    SidebarItem(
                                      icon: Icons.account_balance_rounded,
                                      label: widget.l10n.adminFinancialCenter,
                                      isSelected: _selectedIndex == 28,
                                      onTap: () {
                                        setState(() => _selectedIndex = 28);
                                        _navigate('/admin/financial-center');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.menu_book_rounded,
                                      label: widget.l10n.adminTransactionLedger,
                                      isSelected: _selectedIndex == 29,
                                      onTap: () {
                                        setState(() => _selectedIndex = 29);
                                        _navigate('/admin/transaction-ledger');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.account_balance_wallet_rounded,
                                      label: widget.l10n.adminWalletIntelligence,
                                      isSelected: _selectedIndex == 30,
                                      onTap: () {
                                        setState(() => _selectedIndex = 30);
                                        _navigate('/admin/wallet-intelligence');
                                      },
                                    ),
                                    _AdminGroupLabel(
                                      label: widget.l10n.adminMarketingSection,
                                    ),
                                    SidebarItem(
                                      icon: Icons.trending_up_rounded,
                                      label: widget.l10n.adminServicePerformance,
                                      isSelected: _selectedIndex == 31,
                                      onTap: () {
                                        setState(() => _selectedIndex = 31);
                                        _navigate('/admin/service-performance');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.campaign_rounded,
                                      label: widget.l10n.adminPushNotifications,
                                      isSelected: _selectedIndex == 32,
                                      onTap: () {
                                        setState(() => _selectedIndex = 32);
                                        _navigate('/admin/push-notifications');
                                      },
                                    ),
                                    _AdminGroupLabel(
                                      label: widget.l10n.adminAdvancedSection,
                                    ),
                                    SidebarItem(
                                      icon: Icons.insights_rounded,
                                      label: widget.l10n.adminAnalytics,
                                      isSelected: _selectedIndex == 33,
                                      onTap: () {
                                        setState(() => _selectedIndex = 33);
                                        _navigate('/admin/analytics');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.route_rounded,
                                      label: widget.l10n.adminDeliveryIntelligence,
                                      isSelected: _selectedIndex == 34,
                                      onTap: () {
                                        setState(() => _selectedIndex = 34);
                                        _navigate('/admin/delivery-intelligence');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.shopping_bag_rounded,
                                      label: widget.l10n.adminMerchantIntelligence,
                                      isSelected: _selectedIndex == 35,
                                      onTap: () {
                                        setState(() => _selectedIndex = 35);
                                        _navigate('/admin/merchant-intelligence');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.handyman_rounded,
                                      label: widget.l10n.adminProviderIntelligence,
                                      isSelected: _selectedIndex == 36,
                                      onTap: () {
                                        setState(() => _selectedIndex = 36);
                                        _navigate('/admin/provider-intelligence');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.settings_rounded,
                                      label: widget.l10n.adminSettingsPage,
                                      isSelected: _selectedIndex == 37,
                                      onTap: () {
                                        setState(() => _selectedIndex = 37);
                                        _navigate('/admin/settings');
                                      },
                                    ),
                                    SidebarItem(
                                      icon: Icons.dashboard_rounded,
                                      label: widget.l10n.adminLegacyDashboard,
                                      isSelected: _selectedIndex == 38,
                                      onTap: () {
                                        setState(() => _selectedIndex = 38);
                                        _navigate('/admin/legacy');
                                      },
                                    ),
                                  ],
                                ),
...
class _AdminGroupLabel extends StatelessWidget {
  const _AdminGroupLabel({required this.label});
