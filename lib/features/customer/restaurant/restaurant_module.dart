...
import 'package:delwaqty/features/customer/restaurant/data/datasources/remote/supabase_modifier_data_source.dart';
import 'package:delwaqty/features/customer/restaurant/data/datasources/remote/supabase_restaurant_settings_data_source.dart';
...
import 'package:delwaqty/features/customer/restaurant/data/datasources/remote/supabase_inventory_data_source.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/branch_repository_impl.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/working_hours_repository_impl.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/delivery_zone_repository_impl.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/modifier_repository_impl.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/restaurant_settings_repository_impl.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/offer_repository_impl.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/reservation_repository_impl.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/order_tracking_repository_impl.dart';
import 'package:delwaqty/features/customer/restaurant/data/repositories/inventory_repository_impl.dart';
...
import 'package:delwaqty/features/customer/restaurant/domain/repositories/modifier_repository.dart';
import 'package:delwaqty/features/customer/restaurant/domain/repositories/restaurant_settings_repository.dart';
...
import 'package:delwaqty/features/customer/restaurant/domain/repositories/inventory_repository.dart';
import 'package:delwaqty/features/customer/restaurant/presentation/pages/restaurant_detail_page.dart';
import 'package:delwaqty/features/customer/restaurant/presentation/pages/restaurant_menu_page.dart';
import 'package:delwaqty/features/customer/restaurant/presentation/pages/restaurant_offers_page.dart';
import 'package:delwaqty/features/customer/restaurant/presentation/pages/restaurant_reviews_page.dart';
import 'package:delwaqty/features/customer/restaurant/presentation/pages/restaurant_reservation_page.dart';
import 'package:delwaqty/features/customer/restaurant/presentation/pages/restaurant_order_tracking_page.dart';
import 'package:delwaqty/features/customer/restaurant/presentation/pages/restaurant_gallery_page.dart';
  ...
  List<RouteBase> get standaloneRoutes => [
        GoRoute(
          ...
          routes: [
            ...
            GoRoute(
              path: 'gallery',
              builder: (context, state) => RestaurantGalleryPage(
                merchantId: state.pathParameters['merchantId']!,
              ),
            ),
          ],
