...
import 'package:delwaqty/provider/app.dart';
...
import 'package:delwaqty/provider/module_registry.dart';
...
void main() async {
  ...
  NotificationRouteResolver.appContext = AppContext.provider;
