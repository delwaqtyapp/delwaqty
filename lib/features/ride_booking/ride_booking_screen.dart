...
import 'package:delwaqty/features/ride_booking/location_header_card.dart';
import 'package:delwaqty/features/ride_booking/pickup_destination_card.dart';
import 'package:delwaqty/features/ride_booking/quick_destination_cards.dart';
import 'package:delwaqty/features/ride_booking/recent_destinations_section.dart';
import 'package:delwaqty/features/ride_booking/safety_card.dart';
import 'package:delwaqty/features/ride_booking/primary_cta_button.dart';
...
class _RideBookingPageState extends ConsumerState<RideBookingPage>
  ...
  Widget _buildBottomBar(AppLocalizations l10n, RideBookingState booking) {
    ...
    if (isReview) {
      ctaText = '${l10n.confirmRide} · ${_money(context, booking.finalFare)}';
