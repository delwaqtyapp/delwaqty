...
void main() {
  group('MerchantCard', () {
    ...
    testWidgets('displays delivery info when delivery available', (tester) async {
      ...
      expect(find.text('10 Ø¬.Ù…'), findsOneWidget);
    });
  ...
  group('ProductCard', () {
    ...
    testWidgets('displays price', (tester) async {
      ...
      expect(find.text('35 Ø¬.Ù…'), findsOneWidget);
    });
  ...
  group('PriceTag', () {
    testWidgets('displays price with Ø¬.Ù…', (tester) async {
    ...
    testWidgets('hides original price when originalPrice <= price',
      ...
      expect(find.text('50 Ø¬.Ù…'), findsOneWidget);
  ...
  group('DeliveryInfo', () {
    ...
    testWidgets('displays delivery fee', (tester) async {
      ...
      expect(find.text('15 Ø¬.Ù…'), findsOneWidget);
    });
    ...
    testWidgets('displays minimum order', (tester) async {
      ...
      expect(find.text('Min 25 Ø¬.Ù…'), findsOneWidget);
    });
